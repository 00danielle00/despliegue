...
import 'matricular_alumno_asign_model.dart';
export 'matricular_alumno_asign_model.dart';

class MatricularAlumnoAsignWidget extends StatefulWidget {
  const MatricularAlumnoAsignWidget({
    super.key,
  ...
  static String routeName = 'matricularAlumnoAsign';
  static String routePath = '/matricularAlumnoAsign';

  @override
  State<MatricularAlumnoAsignWidget> createState() =>
      _MatricularAlumnoAsignWidgetState();
}

class _MatricularAlumnoAsignWidgetState
    extends State<MatricularAlumnoAsignWidget> {
  late MatricularAlumnoAsignModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatricularAlumnoAsignModel());
  }
