...
import 'anyadir_alumno_model.dart';
export 'anyadir_alumno_model.dart';

class AnyadirAlumnoWidget extends StatefulWidget {
  const AnyadirAlumnoWidget({super.key});

  static String routeName = 'anyadirAlumno';
  static String routePath = '/anyadirAlumno';

  @override
  State<AnyadirAlumnoWidget> createState() => _AnyadirAlumnoWidgetState();
}

class _AnyadirAlumnoWidgetState extends State<AnyadirAlumnoWidget> {
  late AnyadirAlumnoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnyadirAlumnoModel());
